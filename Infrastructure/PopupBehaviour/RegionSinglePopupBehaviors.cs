...
namespace Infrastructure.PopupBehaviour
{
    ...
    /// </remarks>
    public static class RegionSinglePopupBehaviors
    {
        public static readonly DependencyProperty CreatePopupRegionWithNameProperty =
            DependencyProperty.RegisterAttached("CreatePopupRegionWithName", typeof(string), typeof(RegionSinglePopupBehaviors), new PropertyMetadata(CreatePopupRegionWithNamePropertyChanged));

        public static readonly DependencyProperty CreateModalPopupRegionWithNameProperty =
            DependencyProperty.RegisterAttached("CreateModalPopupRegionWithName", typeof(string), typeof(RegionSinglePopupBehaviors), new PropertyMetadata(CreateModalPopupRegionWithNamePropertyChanged));


        public static readonly DependencyProperty ContainerWindowStyleProperty =
          DependencyProperty.RegisterAttached("ContainerWindowStyle", typeof(Style), typeof(RegionSinglePopupBehaviors), null);
